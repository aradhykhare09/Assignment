                ...
                {products.length === 0 ? (
                    <div className="text-center py-20 bg-white dark:bg-gray-900 rounded-lg border border-dashed border-gray-300 dark:border-gray-700">
                        <div className="max-w-md mx-auto px-4">
                            <h3 className="mt-2 text-lg font-semibold text-gray-900 dark:text-white">No books loaded yet</h3>
                            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 mb-6">
                                We explore World of Books in real-time. Click below to fetch books for this category.
                            </p>
                            <div className="flex justify-center">
                                <ScrapeProductsButton slug={slug} label="Fetch Books Now" />
                            </div>
                        </div>
                    </div>
                ) : (
